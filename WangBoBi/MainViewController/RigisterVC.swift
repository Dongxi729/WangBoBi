    ...
    override func viewWillLayoutSubviews() {
        ...
        if UIApplication.shared.statusBarFrame != rect {
            ...
            if statusframe_changed {
                self.AddLabel.frame = CGRect.init(x: SCREEN_WIDTH * 0.18438001992046, y: SCREEN_HEIGHT * 0.39 - 10 * SCREEN_SCALE, width: SCREEN_WIDTH * 0.88 - SCREEN_WIDTH * 0.213, height: 30 * SCREEN_SCALE)
